...
//        lastData = Math.round(Math.random() * 4500);
//        d = Math.round(Math.random() * 3000);

        // ajax getting data...............
        $.get("rept.do?md=getPerMinuteInfo", { k: "20170412"},function(data){
            d = parseInt(data.reChargeMoney); // 充值金额
            lastData = data.reChargeSuccCount; // 充值笔数
